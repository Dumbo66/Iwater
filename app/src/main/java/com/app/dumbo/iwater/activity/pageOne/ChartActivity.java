...
import com.app.dumbo.iwater.activity.adapter.MyRecyclerAdapter;
...
public class ChartActivity extends BaseActivity {
    ...
    private View chartTypeWindow;//选择图标弹窗
    ...
    private RelativeLayout barChart;
    private RelativeLayout radarChart;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //标题栏
        Calendar calendar = Calendar.getInstance(); //获取今年今月今日
    ...
    public void setListener() {
        ...
        chartTypeShow.setOnClickListener(this);
        chartTypeDismiss.setOnClickListener(this);
        lineChart.setOnClickListener(this);
        barChart.setOnClickListener(this);
        radarChart.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
       ...
       switch (v.getId()){
           //选择日期
           case R.id.rl_date:
               showDatePickerDialog(site);
               break;

           //图表类型切换按钮监听
           case R.id.chart_type_show:
               DisplayMetrics dm = getResources().getDisplayMetrics(); //获取屏幕尺寸
    ...
    /**请求监测数据*/
    private void callMonitorData( String site, String date) {
        Call<WaterDataReception> waterDataCall = Retrofit2.getService().getPerHourWaterData(site,date);
        waterDataCall.enqueue(new Callback<WaterDataReception>() {
            @Override
            public void onResponse(@NonNull Call<WaterDataReception> call,
                                   @NonNull Response<WaterDataReception> response) {
            ...
            @Override
            public void onFailure(@NonNull Call<WaterDataReception> call, @NonNull Throwable t) {
    ...
    /**显示日期选择对话框*/
    @SuppressLint("SetTextI18n")
    private void showDatePickerDialog(final String site) {
