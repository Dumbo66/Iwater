...
/**
 * Created by dumbo on 2018/8/17
 **/

public class FragmentPermUtil {
    /**
    ...
    //自己的项目包名
    private String packageName = "com.app.dumbo.iwater";

    public FragmentPermUtil(Activity activity,Fragment fragment) {
    ...
    private void goLGMainager() {
        try {
            ...
            fragment.startActivityForResult(intent, RequestCode.REQUEST_PERMISSION_CODE);
        } catch (Exception e) {
